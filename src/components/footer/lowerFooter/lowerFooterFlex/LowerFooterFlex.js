                ...
                <table className={styles.table}>
                    <tbody>
                        <tr>
                            ...
                            <td className={styles.tableContainer}><div className={styles.socialMediaContainer}>
                                <a className={styles.anchor} href="/"><Facebook className={styles.socialMediaBtn} fill="#ffffff" /></a>
                                <a className={styles.anchor} href="/"><Twitter className={styles.socialMediaBtn} fill="#ffffff" /></a>
                                <a className={styles.anchor} href="/"><Google className={styles.socialMediaBtn} fill="#ffffff" /></a>
                                <a className={styles.anchor} href="/"><Instagram className={styles.socialMediaBtn} fill="#ffffff" /></a>
                            </div></td>
